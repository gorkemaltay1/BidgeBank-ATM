...
master.title("Money Deposit Checking")
...
message=Label(select,text=' Your money added to checking amount. ',bg='lightgreen', font='Verdana 25 ', pady=20, padx=10)
message.pack(padx=50,pady=5,side=LEFT)
